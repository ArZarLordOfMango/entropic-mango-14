...
namespace Content.Shared.GameTicking
{
    public abstract class SharedGameTicker : EntitySystem
    {
        ...
        public static readonly ProtoId<JobPrototype> FallbackOverflowJob = "EMJobPassenger"; //BASELINE - Replace it with default fallback job of your fork

        public const string FallbackOverflowJobName = "em-job-name-passenger";
